...
# pm4py is an optional extra (processlog[xes]); skip the real-XES tests when
# it isn't installed. The actionable-error path is covered without it in
# test_xes_optional_dependency.py.
